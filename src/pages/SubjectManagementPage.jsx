...
function SubjectFormModal({ subject, onClose, onSave }) {
  ...
  const validateForm = () => {
    ...
    else if (!/^[a-zA-Z0-9\s]*$/.test(formData.subjectCode)) newErrors.subjectCode = 'Subject Code cannot contain special characters or spaces.';
      ...
      <div style={styles.modalContent} onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={styles.formGrid}>
            ...
            <div style={styles.formGroup}><label style={styles.label}>Term</label><select style={styles.input} name="term" value={formData.term} onChange={handleChange} required><option>Spring</option><option>Autumn</option><option>Summer A</option><option>Summer B</option><option>1H</option><option>2H</option><option>Q1</option><option>Q2</option><option>Q3</option><option>Q4</option></select><p style={styles.errorMessage}></p></div>
